<template>
  <div>
    <v-container class="mt-16">
      <v-row no-gutters>
        <v-col v-for="post in posts" :key="post.attributes.id" :title="post.attributes.title" :time="post.attributes.date"
          ...
          <v-card class="rounded-xl" color="#010101" max-width="400" elevation="10" outlined>
            ...
            <v-card-text class="mr-n14 mt-3">
              <h3 style="color:white">{{ post.attributes.title }}</h3>
            </v-card-text>
            <v-card-actions>
